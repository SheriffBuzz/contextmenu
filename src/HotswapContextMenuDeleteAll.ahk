#NoEnv
/*
    Static version of HotswapContextMenu.ahk that can be used to load all for the first time.
*/
...
HotswapContextMenu("C:\toolkit\registry\contextmenu\hotswap\hotswap.json","DeleteAll")
